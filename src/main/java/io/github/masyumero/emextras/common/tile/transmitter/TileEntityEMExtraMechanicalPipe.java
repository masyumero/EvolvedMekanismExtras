...
public class TileEntityEMExtraMechanicalPipe extends TileEntityEMExtraTransmitter implements IComputerTile {

    private final FluidHandlerManager fluidHandlerManager;

    public TileEntityEMExtraMechanicalPipe(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
        super(blockProvider, pos, state);
        addCapabilityResolver(fluidHandlerManager = new FluidHandlerManager(direction -> {
            EMExtraMechanicalPipe pipe = getTransmitter();
    ...
    @Override
    protected EMExtraMechanicalPipe createTransmitter(IBlockProvider blockProvider) {
        return new EMExtraMechanicalPipe(blockProvider, this);
    }

    @Override
    public EMExtraMechanicalPipe getTransmitter() {
        return (EMExtraMechanicalPipe) super.getTransmitter();
    }
