...
public class EMExtraUniversalCable extends UniversalCable implements IEMExtraUpgradeableTransmitter<UniversalCableUpgradeData> {

    public EMExtraUniversalCable(IBlockProvider blockProvider, TileEntityTransmitter tile) {
    ...
    public FloatingLong getCapacityAsFloatingLong() {
        return EMExtraCTier.getCapacityAsFloatingLong(tier);
    }
