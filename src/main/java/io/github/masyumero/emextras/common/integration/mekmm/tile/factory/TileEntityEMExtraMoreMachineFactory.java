...
public abstract class TileEntityEMExtraMoreMachineFactory<RECIPE extends MekanismRecipe<?>> extends TileEntityConfigurableMachine implements IRecipeLookupHandler<RECIPE> {
    ...
    protected TileEntityEMExtraMoreMachineFactory(Holder<Block> blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
    ...
    protected void presetVariables() {
        ...
        tier = EMExtraAttribute.getEMExtraTier(getBlockHolder(), EMExtraFactoryTier.class);
    ...
    public MachineEnergyContainer<TileEntityEMExtraMoreMachineFactory<?>> getEnergyContainer() {
    ...
    private static class RecipeProcessInfo<RECIPE extends MekanismRecipe<?>> {
        ...
        @Nullable
        private ToIntBiFunction<RecipeProcessInfo<RECIPE>, TileEntityEMExtraMoreMachineFactory<RECIPE>> lazyMinPerSlot;
        private Object item;
        private RECIPE recipe;
        private int minPerSlot = 1;
        private int totalCount;

        public int getMinPerSlot(TileEntityEMExtraMoreMachineFactory<RECIPE> factory) {
