...
public class TileEntityMetallurgicInfuserEMExtraFactory extends TileEntityItemToItemEMExtraFactory<MetallurgicInfuserRecipe> implements IHasDumpButton,
    ...
    public TileEntityMetallurgicInfuserEMExtraFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
