...
public class TileEntityEMExtraUniversalCable extends TileEntityEMExtraTransmitter implements IComputerTile {

    private final EnergyHandlerManager energyHandlerManager;

    public TileEntityEMExtraUniversalCable(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
        super(blockProvider, pos, state);
        addCapabilityResolver(energyHandlerManager = new EnergyHandlerManager(direction -> {
            EMExtraUniversalCable cable = getTransmitter();
    ...
    @Override
    protected EMExtraUniversalCable createTransmitter(IBlockProvider blockProvider) {
        return new EMExtraUniversalCable(blockProvider, this);
    }

    @Override
    public EMExtraUniversalCable getTransmitter() {
        return (EMExtraUniversalCable) super.getTransmitter();
    }
