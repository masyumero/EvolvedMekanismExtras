...
public class EMExtraThermodynamicConductor extends ThermodynamicConductor implements IEMExtraUpgradeableTransmitter<ThermodynamicConductorUpgradeData> {
    ...
    public EMExtraThermodynamicConductor(IBlockProvider blockProvider, TileEntityTransmitter tile) {
        super(blockProvider, tile);
        this.tier = Attribute.getTier(blockProvider, ConductorTier.class);
        buffer = ExtraVariableHeatCapacitor.create(EMExtraTCTier.getHeatCapacity(tier), EMExtraTCTier.getConduction(tier), EMExtraTCTier.getConductionInsulation(tier), ambientTemperature, this);
