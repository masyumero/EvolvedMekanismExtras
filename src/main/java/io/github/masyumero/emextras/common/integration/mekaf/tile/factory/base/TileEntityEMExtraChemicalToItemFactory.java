...
public abstract class TileEntityEMExtraChemicalToItemFactory<RECIPE extends MekanismRecipe<?>> extends TileEntityEMExtraAdvancedFactoryBase<RECIPE> {

    protected CIProcessInfo[] processInfoSlots;
    public EMExtraAdvancedFactoryOutputInventorySlot[] outputSlot;
    public IChemicalTank[] inputTank;

    public List<IChemicalTank> inputChemicalTanks;
    public List<IInventorySlot> outputItemSlots;

    protected TileEntityEMExtraChemicalToItemFactory(Holder<Block> blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
    ...
    protected void addSlots(InventorySlotHelper builder, IContentsListener listener, IContentsListener updateSortingListener) {
        ...
        for (int i = 0; i < tier.processes; i++) {
            ...
            int index = i;
            outputSlot[i] = EMExtraAdvancedFactoryOutputInventorySlot.at(this, updateSortingAndUnpause, getXPos(i), 70);
    ...
    protected static class CIRecipeProcessInfo<RECIPE extends MekanismRecipe<?>> {
        ...
        @Nullable
        private ToIntBiFunction<CIRecipeProcessInfo<RECIPE>, TileEntityEMExtraChemicalToItemFactory<RECIPE>> lazyMinPerTank;
        private Object chemical;
        private RECIPE recipe;
        private long minPerTank = 1;
        private long totalCount;

        public long getMinPerTank(TileEntityEMExtraChemicalToItemFactory<RECIPE> factory) {
