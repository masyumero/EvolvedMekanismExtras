...
public class TileEntityEMExtraPRCFactory extends TileEntityEMExtraAdvancedBase<PressurizedReactionRecipe> implements IHasDumpButton,
    ...
    public TileEntityEMExtraPRCFactory(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
    ...
    protected void addSlots(InventorySlotHelper builder, IContentsListener listener, IContentsListener updateSortingListener) {
        ...
        for (int i = 0; i < tier.processes; i++) {
            ...
            // listener directly
            EMExtraAdvancedFactoryInputInventorySlot inputSlot = EMExtraAdvancedFactoryInputInventorySlot.create(this, i, outputSlot, outputChemicalTank, recipeCacheLookupMonitors[i], getXPos(i), 13);
            int index = i;
    ...
    public record PRCProcessInfo(int process, @NotNull EMExtraAdvancedFactoryInputInventorySlot inputSlot,
    ...
    protected static class PRCRecipeProcessInfo {
        ...
        @Nullable
        private ToIntBiFunction<PRCRecipeProcessInfo, TileEntityEMExtraPRCFactory> lazyMinPerSlot;
        private Object item;
        private PressurizedReactionRecipe recipe;
        private int minPerSlot = 1;
        private int totalCount;

        public int getMinPerSlot(TileEntityEMExtraPRCFactory factory) {
