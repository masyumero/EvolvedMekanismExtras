...
import io.github.masyumero.emextras.common.integration.mekaf.tile.factory.base.TileEntityEMExtraItemToFluidFactory;
...
public class TileEntityEMExtraLiquifyingFactory extends TileEntityEMExtraItemToFluidFactory<ItemStackToFluidRecipe> {
    ...
    public TileEntityEMExtraLiquifyingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
