...
public class EMExtraItems {
    ...
    public static final ItemRegistryObject<Item> BASE_CONTROL_CIRCUIT = ITEM.registerItem("base_control_circuit", properties -> new Item(properties.rarity(Rarity.COMMON)));
    ...
    private static ItemRegistryObject<Item> registerCircuit(String name, Rarity rarity, EMExtraTier tier) {
        return ITEM.registerItem(name + "_control_circuit", properties -> new Item(properties.rarity(rarity)) {
            @Override
    ...
    private static ItemRegistryObject<EMExtraItemTierInstaller> registerInstaller(@Nullable EMExtraTier fromTier, @NotNull EMExtraTier toTier) {
        ...
        return ITEM.registerItem(toTier.getLowerName() + "_tier_installer", properties -> new EMExtraItemTierInstaller(fromTier, toTier, properties));
    }
