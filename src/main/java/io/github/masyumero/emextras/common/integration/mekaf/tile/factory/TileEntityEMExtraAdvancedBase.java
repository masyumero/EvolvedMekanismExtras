...
public abstract class TileEntityEMExtraAdvancedBase<RECIPE extends MekanismRecipe<?>> extends TileEntityConfigurableMachine implements IRecipeLookupHandler<RECIPE> {
    ...
    protected TileEntityEMExtraAdvancedBase(Holder<Block> blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
    ...
    protected IEnergyContainerHolder getInitialEnergyContainers(IContentsListener listener) {
        ...
        builder.addContainer(energyContainer = EMExtraAdvancedFactoryEnergyContainer.input(this, () -> {
            listener.onContentsChanged();
            for (FactoryRecipeCacheLookupMonitor<RECIPE> cacheLookupMonitor : recipeCacheLookupMonitors) {
    ...
    public EMExtraAdvancedFactoryEnergyContainer getEnergyContainer() {
