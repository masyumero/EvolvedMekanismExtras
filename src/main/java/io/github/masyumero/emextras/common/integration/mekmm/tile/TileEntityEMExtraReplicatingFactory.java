...
public class TileEntityEMExtraReplicatingFactory extends TileEntityEMExtraItemToItemFactory<ItemStackGasToItemStackRecipe> implements IHasDumpButton,
    ...
    public TileEntityEMExtraReplicatingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
