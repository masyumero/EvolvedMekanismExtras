...
public abstract class TileEntityEMExtraItemToChemicalFactory<RECIPE extends MekanismRecipe<?>> extends TileEntityEMExtraAdvancedFactoryBase<RECIPE> {
    ...
    protected TileEntityEMExtraItemToChemicalFactory(Holder<Block> blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
    ...
    public record ICProcessInfo(int process, @NotNull EMExtraAdvancedFactoryInputInventorySlot inputSlot,
    ...
    protected static class ICRecipeProcessInfo<RECIPE extends MekanismRecipe<?>> {
        ...
        @Nullable
        private ToIntBiFunction<ICRecipeProcessInfo<RECIPE>, TileEntityEMExtraItemToChemicalFactory<RECIPE>> lazyMinPerSlot;
        private Object item;
        private RECIPE recipe;
        private int minPerSlot = 1;
        private int totalCount;

        public int getMinPerSlot(TileEntityEMExtraItemToChemicalFactory<RECIPE> factory) {
