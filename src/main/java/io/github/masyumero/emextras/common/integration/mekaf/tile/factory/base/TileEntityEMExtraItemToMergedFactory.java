...
public abstract class TileEntityEMExtraItemToMergedFactory<RECIPE extends MekanismRecipe> extends TileEntityEMExtraAdvancedFactoryBase<RECIPE> {
    ...
    protected TileEntityEMExtraItemToMergedFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
    ...
    public record ItemToMergedProcessInfo(int process, @NotNull EMExtraAdvancedFactoryInputInventorySlot inputSlot,
