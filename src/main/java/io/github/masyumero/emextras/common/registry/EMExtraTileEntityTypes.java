...
public class EMExtraTileEntityTypes {
    ...
    static {
        for (EMExtraFactoryTier tier : EMExtraEnumUtils.EMEXTRA_FACTORY_TIERS) {
            registerFactory(tier, EMExtraFactoryType.SMELTING, TileEntityEMExtraItemStackToItemStackFactory::new);
            registerFactory(tier, EMExtraFactoryType.CRUSHING, TileEntityEMExtraItemStackToItemStackFactory::new);
            registerFactory(tier, EMExtraFactoryType.ENRICHING, TileEntityEMExtraItemStackToItemStackFactory::new);
            registerFactory(tier, EMExtraFactoryType.COMPRESSING, TileEntityEMExtraItemStackChemicalToItemStackFactory::new);
            registerFactory(tier, EMExtraFactoryType.INJECTING, TileEntityEMExtraItemStackChemicalToItemStackFactory::new);
            registerFactory(tier, EMExtraFactoryType.PURIFYING, TileEntityEMExtraItemStackChemicalToItemStackFactory::new);
            registerFactory(tier, EMExtraFactoryType.INFUSING, TileEntityEMExtraItemStackChemicalToItemStackFactory::new);
            registerFactory(tier, EMExtraFactoryType.COMBINING, TileEntityEMExtraCombiningFactory::new);
            registerFactory(tier, EMExtraFactoryType.SAWING, TileEntityEMExtraSawingFactory::new);
            registerFactory(tier, EMExtraFactoryType.ALLOYING, TileEntityEMExtraAlloyingFactory::new);
        }
    ...
    private static void registerFactory(EMExtraFactoryTier tier, EMExtraFactoryType type, BlockEntityFactory<? extends TileEntityEMExtraFactory<?>> factoryConstructor) {
