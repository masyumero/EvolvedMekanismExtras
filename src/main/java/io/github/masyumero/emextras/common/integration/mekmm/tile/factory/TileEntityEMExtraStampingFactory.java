...
public class TileEntityEMExtraStampingFactory extends TileEntityEMExtraItemToItemMoreMachineFactory<StamperRecipe> implements DoubleItemRecipeLookupHandler<StamperRecipe> {
    ...
    public TileEntityEMExtraStampingFactory(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
