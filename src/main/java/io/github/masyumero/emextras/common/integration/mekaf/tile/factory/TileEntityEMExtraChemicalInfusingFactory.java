...
public class TileEntityEMExtraChemicalInfusingFactory extends TileEntityEMExtraChemicalToChemicalFactory<ChemicalChemicalToChemicalRecipe> implements IHasDumpButton, EitherSideChemicalRecipeLookupHandler<ChemicalChemicalToChemicalRecipe> {
    ...
    public TileEntityEMExtraChemicalInfusingFactory(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
