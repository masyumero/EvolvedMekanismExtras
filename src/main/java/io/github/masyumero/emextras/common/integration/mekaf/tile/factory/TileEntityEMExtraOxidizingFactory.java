...
public class TileEntityEMExtraOxidizingFactory extends TileEntityEMExtraItemToChemicalFactory<ItemStackToChemicalRecipe> implements ItemRecipeLookupHandler<ItemStackToChemicalRecipe> {
    ...
    public TileEntityEMExtraOxidizingFactory(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
