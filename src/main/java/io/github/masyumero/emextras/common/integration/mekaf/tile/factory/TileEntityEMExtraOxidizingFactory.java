...
import io.github.masyumero.emextras.common.integration.mekaf.tile.factory.base.TileEntityEMExtraItemToGasFactory;
...
public class TileEntityEMExtraOxidizingFactory extends TileEntityEMExtraItemToGasFactory<ItemStackToGasRecipe> implements ItemRecipeLookupHandler<ItemStackToGasRecipe> {
    ...
    public TileEntityEMExtraOxidizingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
