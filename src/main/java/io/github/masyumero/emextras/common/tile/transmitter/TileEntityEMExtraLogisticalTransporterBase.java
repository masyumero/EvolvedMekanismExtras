...
public abstract class TileEntityEMExtraLogisticalTransporterBase extends TileEntityEMExtraTransmitter {

    protected TileEntityEMExtraLogisticalTransporterBase(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
        super(blockProvider, pos, state);
        addCapabilityResolver(new TileEntityEMExtraLogisticalTransporterBase.TransporterCapabilityResolver());
    }
    ...
    public static void tickClient(Level level, BlockPos pos, BlockState state, TileEntityEMExtraLogisticalTransporterBase transmitter) {
