...
public class TileEntityEMExtraThermodynamicConductor extends TileEntityEMExtraTransmitter {

    private final HeatHandlerManager heatHandlerManager;

    public TileEntityEMExtraThermodynamicConductor(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
        super(blockProvider, pos, state);
        addCapabilityResolver(heatHandlerManager = new HeatHandlerManager(direction -> {
            EMExtraThermodynamicConductor conductor = getTransmitter();
    ...
    @Override
    protected EMExtraThermodynamicConductor createTransmitter(IBlockProvider blockProvider) {
        return new EMExtraThermodynamicConductor(blockProvider, this);
    }

    @Override
    public EMExtraThermodynamicConductor getTransmitter() {
        return (EMExtraThermodynamicConductor) super.getTransmitter();
    }
