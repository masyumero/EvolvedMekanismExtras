...
public class EMExtraAdvancedFactoryContainer extends MekanismTileContainer<TileEntityEMExtraAdvancedFactoryBase<?>> {
    ...
    public EMExtraAdvancedFactoryContainer(int id, Inventory inv, TileEntityEMExtraAdvancedFactoryBase<?> tile) {
    ...
    protected int getInventoryYOffset() {
        if (tile.hasExtraResourceBar()) {
            return tile instanceof TileEntityEMExtraChemicalToChemicalFactory<?> ? 121 : tile instanceof TileEntityEMExtraPRCFactory ? 103 : tile instanceof TileEntityEMExtraPaintingFactory ? 96 : 108;
        }
