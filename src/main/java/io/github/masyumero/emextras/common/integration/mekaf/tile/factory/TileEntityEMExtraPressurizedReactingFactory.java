...
public class TileEntityEMExtraPressurizedReactingFactory extends TileEntityEMExtraAdvancedFactoryBase<PressurizedReactionRecipe> implements IHasDumpButton, ItemFluidChemicalRecipeLookupHandler<Gas, GasStack, PressurizedReactionRecipe> {
    ...
    public TileEntityEMExtraPressurizedReactingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    protected void addSlots(InventorySlotHelper builder, IContentsListener listener, IContentsListener updateSortingListener) {
        ...
        for (int i = 0; i < tier.processes; i++) {
            ...
            EMExtraAdvancedFactoryInputInventorySlot inputSlot = EMExtraAdvancedFactoryInputInventorySlot.create(this, i, outputSlot, outputGasTank, recipeCacheLookupMonitors[i], getXPos(i), 13);
            int index = i;
