...
public class TileEntityEMExtraStampingFactory extends TileEntityEMExtraItemToItemFactory<StamperRecipe> implements DoubleItemRecipeLookupHandler<StamperRecipe> {
    ...
    public TileEntityEMExtraStampingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    @Nullable
    @Override
    protected InputInventorySlot getEMExtraSlot() {
        return moldSlot;
    }
