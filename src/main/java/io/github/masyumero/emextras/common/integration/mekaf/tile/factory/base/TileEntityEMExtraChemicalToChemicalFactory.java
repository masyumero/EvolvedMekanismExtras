...
public abstract class TileEntityEMExtraChemicalToChemicalFactory<RECIPE extends MekanismRecipe<?>> extends TileEntityEMExtraAdvancedFactoryBase<RECIPE> {
    ...
    protected TileEntityEMExtraChemicalToChemicalFactory(Holder<Block> blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
    ...
    protected static class CCRecipeProcessInfo<RECIPE extends MekanismRecipe<?>> {
        ...
        @Nullable
        private ToIntBiFunction<CCRecipeProcessInfo<RECIPE>, TileEntityEMExtraChemicalToChemicalFactory<RECIPE>> lazyMinPerTank;
        private Object chemical;
        private RECIPE recipe;
        private long minPerTank = 1;
        private long totalAmount;

        public long getMinPerTank(TileEntityEMExtraChemicalToChemicalFactory<RECIPE> factory) {
