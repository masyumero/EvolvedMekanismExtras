...
public class ItemBlockEMExtraTooltip<BLOCK extends Block & IHasDescription> extends ItemBlockEMExtra<BLOCK> implements ICapabilityAware, IAttachmentAware {

    private final boolean hasDetails;

    public ItemBlockEMExtraTooltip(BLOCK block, Properties properties) {
        this(block, false, properties);
    }

    protected ItemBlockEMExtraTooltip(BLOCK block, boolean hasDetails, Properties properties) {
