...
public class RenderEMExtraLogisticalTransporter extends RenderTransmitterBase<TileEntityEMExtraLogisticalTransporterBase> {
    ...
    public RenderEMExtraLogisticalTransporter(BlockEntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    protected void render(TileEntityEMExtraLogisticalTransporterBase tile, float partialTick, PoseStack matrix, MultiBufferSource renderer, int light, int overlayLight,
                          ProfilerFiller profiler) {
        EMExtraLogisticalTransporter transporter = (EMExtraLogisticalTransporter) tile.getTransmitter();
        ...
        if (!inTransit.isEmpty()) {
            ...
            float partial = partialTick * EMExtraTPTier.getSpeed(transporter.tier);
