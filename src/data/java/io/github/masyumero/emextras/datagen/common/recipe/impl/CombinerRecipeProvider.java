...
public class CombinerRecipeProvider implements ISubRecipeProvider {
    ...
    public void addRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        combinedTransmitter(consumer, basePath, "logistical_transporter", EMExtraBlocks.ABSOLUTE_OVERCLOCKED_LOGISTICAL_TRANSPORTER, ExtraBlocks.ABSOLUTE_LOGISTICAL_TRANSPORTER, EMBlocks.OVERCLOCKED_LOGISTICAL_TRANSPORTER);
        combinedTransmitter(consumer, basePath, "mechanical_pipe", EMExtraBlocks.ABSOLUTE_OVERCLOCKED_MECHANICAL_PIPE, ExtraBlocks.ABSOLUTE_MECHANICAL_PIPE, EMBlocks.OVERCLOCKED_MECHANICAL_PIPE);
        combinedTransmitter(consumer, basePath, "pressurized_tube", EMExtraBlocks.ABSOLUTE_OVERCLOCKED_PRESSURIZED_TUBE, ExtraBlocks.ABSOLUTE_PRESSURIZED_TUBE, EMBlocks.OVERCLOCKED_PRESSURIZED_TUBE);
        combinedTransmitter(consumer, basePath, "thermodynamic_conductor", EMExtraBlocks.ABSOLUTE_OVERCLOCKED_THERMODYNAMIC_CONDUCTOR, ExtraBlocks.ABSOLUTE_THERMODYNAMIC_CONDUCTOR, EMBlocks.OVERCLOCKED_THERMODYNAMIC_CONDUCTOR);
        combinedTransmitter(consumer, basePath, "universal_cable", EMExtraBlocks.ABSOLUTE_OVERCLOCKED_UNIVERSAL_CABLE, ExtraBlocks.ABSOLUTE_UNIVERSAL_CABLE, EMBlocks.OVERCLOCKED_UNIVERSAL_CABLE);

        combinedTransmitter(consumer, basePath, "logistical_transporter", EMExtraBlocks.SUPREME_QUANTUM_LOGISTICAL_TRANSPORTER, ExtraBlocks.SUPREME_LOGISTICAL_TRANSPORTER, EMBlocks.QUANTUM_LOGISTICAL_TRANSPORTER);
        combinedTransmitter(consumer, basePath, "mechanical_pipe", EMExtraBlocks.SUPREME_QUANTUM_MECHANICAL_PIPE, ExtraBlocks.SUPREME_MECHANICAL_PIPE, EMBlocks.QUANTUM_MECHANICAL_PIPE);
        combinedTransmitter(consumer, basePath, "pressurized_tube", EMExtraBlocks.SUPREME_QUANTUM_PRESSURIZED_TUBE, ExtraBlocks.SUPREME_PRESSURIZED_TUBE, EMBlocks.QUANTUM_PRESSURIZED_TUBE);
        combinedTransmitter(consumer, basePath, "thermodynamic_conductor", EMExtraBlocks.SUPREME_QUANTUM_THERMODYNAMIC_CONDUCTOR, ExtraBlocks.SUPREME_THERMODYNAMIC_CONDUCTOR, EMBlocks.QUANTUM_THERMODYNAMIC_CONDUCTOR);
        combinedTransmitter(consumer, basePath, "universal_cable", EMExtraBlocks.SUPREME_QUANTUM_UNIVERSAL_CABLE, ExtraBlocks.SUPREME_UNIVERSAL_CABLE, EMBlocks.QUANTUM_UNIVERSAL_CABLE);

        combinedTransmitter(consumer, basePath, "logistical_transporter", EMExtraBlocks.COSMIC_DENSE_LOGISTICAL_TRANSPORTER, ExtraBlocks.COSMIC_LOGISTICAL_TRANSPORTER, EMBlocks.DENSE_LOGISTICAL_TRANSPORTER);
        combinedTransmitter(consumer, basePath, "mechanical_pipe", EMExtraBlocks.COSMIC_DENSE_MECHANICAL_PIPE, ExtraBlocks.COSMIC_MECHANICAL_PIPE, EMBlocks.DENSE_MECHANICAL_PIPE);
        combinedTransmitter(consumer, basePath, "pressurized_tube", EMExtraBlocks.COSMIC_DENSE_PRESSURIZED_TUBE, ExtraBlocks.COSMIC_PRESSURIZED_TUBE, EMBlocks.DENSE_PRESSURIZED_TUBE);
