...
public class EMExtraRecipeProvider extends BaseRecipeProvider {

    public EMExtraRecipeProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider, ExistingFileHelper existingFileHelper) {
